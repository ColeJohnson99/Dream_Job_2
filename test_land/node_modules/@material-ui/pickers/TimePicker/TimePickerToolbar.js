...
var TimePickerToolbar = function (_a) {
    ...
    return (React.createElement(PickerToolbar_1.default, { className: clsx_1.default(classes.toolbar, (_b = {},
        ...
        React.createElement("div", { className: hourMinuteClassName },
            utils_1.arrayIncludes(views, 'hours') && (React.createElement(React.Fragment, null,
            ...
            utils_1.arrayIncludes(views, 'minutes') && (React.createElement(ToolbarButton_1.default, { variant: "h2", onClick: function () { return setOpenView(ClockType_1.default.MINUTES); }, selected: openView === ClockType_1.default.MINUTES, label: utils.getMinuteText(date) })),
            utils_1.arrayIncludes(views, 'seconds') && (React.createElement(React.Fragment, null,
                React.createElement(ToolbarText_1.default, { variant: "h2", label: ":", selected: false, className: classes.separator }),
        ...
        ampm && (React.createElement("div", { className: clsx_1.default(classes.ampmSelection, (_c = {},
                _c[classes.ampmSelectionWithSeconds] = utils_1.arrayIncludes(views, 'seconds'),
                _c)) },
