            ...
            <Row>
              <Col size="sm-8" className="info-area">
                ...
                <div className="text-container">
                  <p className="header-text">Missed connections can mean missed opportunities—use DreamJob to track all of your contacts' essential information and <span className="dark-bold">keep growing your network!</span></p>
                </div>
